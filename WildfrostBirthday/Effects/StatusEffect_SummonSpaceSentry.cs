...
{
    public static class StatusEffect_SummonSpaceSentry
    {
        /// <summary>
        /// Registers the "Summon SpaceSentry" effect.
        /// </summary>
        public static void Register(WildfrostBirthday.WildFamilyMod mod)
        {
            var builder = new StatusEffectDataBuilder(mod)
                .Create<StatusEffectSummon>("Summon SpaceSentry")
                .WithText("Summon SpaceSentry", SystemLanguage.English)
                ...
                .SubscribeToAfterAllBuildEvent<StatusEffectSummon>(data =>
                {
                    ...
                    data.summonCard = mod.TryGet<CardData>("companion-spacesentry");
                    data.setCardType = mod.TryGet<CardType>("Clunker");
