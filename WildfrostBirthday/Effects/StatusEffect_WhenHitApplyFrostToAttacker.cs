...
{
    public static class StatusEffect_WhenHitApplyFrostToAttacker
    {
        public static void Register(WildFamilyMod mod)
        {
            var builder = new StatusEffectDataBuilder(mod)
                .Create<StatusEffectApplyXWhenHit>("When Hit Apply Frost To Attacker")
                ...
                {
                    data.desc = "When hit, apply <{0}><keyword=frost> to the attacker";
