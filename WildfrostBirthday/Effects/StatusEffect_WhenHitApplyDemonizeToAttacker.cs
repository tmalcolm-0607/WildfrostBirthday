    ...
    public static class StatusEffect_WhenHitApplyDemonizeToAttacker
    {
        public static void Register(WildFamilyMod mod)
        {
            var builder = new StatusEffectDataBuilder(mod)
                .Create<StatusEffectApplyXWhenHit>("When Hit Apply Demonize To Attacker")
                ...
                .WithTextInsert("<{a}><keyword=demonize>")
                .WithStackable(true)
                ...
                {
                    data.desc = "When hit, apply <{0}><keyword=demonize> to the attacker";
                    data.hiddenKeywords = new KeywordData[]
                    {
                        mod.TryGet<KeywordData>("Hit"),
                    };
                    data.effectToApply = mod.TryGet<StatusEffectDemonize>("Demonize");
