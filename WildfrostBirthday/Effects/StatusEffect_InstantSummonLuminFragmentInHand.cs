// Registers the "Instant Summon LuminFragment" effect for the mod.
// No usings needed; all required namespaces are provided by GlobalUsings.cs
 
namespace WildfrostBirthday.Effects
{
    public static class StatusEffect_InstantSummonLuminFragment
    {
        /// <summary>
        /// Registers the "Instant Summon LuminFragment" effect.
        /// </summary>
        public static void Register(WildfrostBirthday.WildFamilyMod mod)
        {
             var builder = new StatusEffectDataBuilder(mod)
                .Create<StatusEffectInstantSummon>("Instant Summon LuminFragment In Hand")
                .WithStackable(false)
                 ...
                 .SubscribeToAfterAllBuildEvent<StatusEffectInstantSummon>(data =>
                {
                     ...
                     data.targetSummon = mod.TryGet<StatusEffectSummon>("Summon LuminFragment");
                });
