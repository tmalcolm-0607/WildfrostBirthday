    ...
    public static class Card_ColossalAmoebom
    {
        ...
        {            string cardId = "colossal_amoebom";
            ...
            var enemyBuilder = new CardDataBuilder(mod)
                ...
                {
                    // Starting effects - 7 weakness and gain 5 weakness when hit
                    var startEffects = new List<CardData.StatusEffectStacks> {
                        mod.SStack("Weakness", 7),
                        mod.SStack("When Hit Apply Weakness To Self", 5),
                        mod.SStack("When Hit Apply Weakness To Attacker", 2),
